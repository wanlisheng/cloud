...
import auth.security.details.client.ClientDetailsServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        endpoints
                ...
                .accessTokenConverter(this.jwtAccessTokenConverter())//包装和抽取令牌
                .tokenEnhancer(tokenEnhancerChain)//token增强器
                .tokenGranter(compositeTokenGranter)//令牌授予器
                .reuseRefreshTokens(false)//可以重复使用
                .tokenServices(this.tokenServices(endpoints))
        ;
    }
